 ...
 * MOCHA system. There are three: the main network on which people trade goods
...
public:
    ...
    int MochaBadBlockTime() const { return nMochaBadBlockTime; }
    int MochaBadBlocknBits() const { return nMochaBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nMochaBadBlockTime;
    unsigned int nMochaBadBlocknBits;
