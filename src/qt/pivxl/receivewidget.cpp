...
#include "qt/mocha/forms/ui_receivewidget.h"
...
#include "qt/mocha/addressholder.h"
...
ReceiveWidget::ReceiveWidget(MOCHAGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive MOCHA."));
