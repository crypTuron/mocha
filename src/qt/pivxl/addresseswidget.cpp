...
#include "qt/mocha/forms/ui_addresseswidget.h"
#include "qt/mocha/addresslabelrow.h"
#include "qt/mocha/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(MOCHAGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter a MOCHA address"));
