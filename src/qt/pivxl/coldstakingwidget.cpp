...
#include "qt/mocha/forms/ui_coldstakingwidget.h"
#include "qt/mocha/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/mocha/requestdialog.h"
#include "qt/mocha/tooltipmenu.h"
#include "qt/mocha/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(MOCHAGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept MOCHA delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select MOCHA outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 MOCHA" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
