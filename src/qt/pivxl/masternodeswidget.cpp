...
#include "qt/mocha/forms/ui_masternodeswidget.h"
#include "qt/mocha/qtutils.h"
#include "qt/mocha/mnrow.h"
#include "qt/mocha/mninfodialog.h"

#include "qt/mocha/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(MOCHAGUI *parent) :
    PWidget(parent),
