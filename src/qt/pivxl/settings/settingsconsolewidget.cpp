...
#include "qt/mocha/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/mocha/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MOCHAGUI* _window, QWidget *parent) :
