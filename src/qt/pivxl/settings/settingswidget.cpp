...
#include "qt/mocha/settings/forms/ui_settingswidget.h"
#include "qt/mocha/settings/settingsbackupwallet.h"
#include "qt/mocha/settings/settingsbittoolwidget.h"
#include "qt/mocha/settings/settingswalletrepairwidget.h"
#include "qt/mocha/settings/settingswalletoptionswidget.h"
#include "qt/mocha/settings/settingsmainoptionswidget.h"
#include "qt/mocha/settings/settingsdisplayoptionswidget.h"
#include "qt/mocha/settings/settingsmultisendwidget.h"
#include "qt/mocha/settings/settingsinformationwidget.h"
#include "qt/mocha/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(MOCHAGUI* parent) :
    PWidget(parent),
