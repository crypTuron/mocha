...
#ifndef MOCHA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define MOCHA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //MOCHA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
