...
#include "qt/mocha/furabstractlistitemdelegate.h"
#include "qt/mocha/txviewholder.h"
#include "qt/mocha/tooltipmenu.h"
#include "qt/mocha/sendmultirow.h"
#include "qt/mocha/coldstakingmodel.h"
#include "qt/mocha/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(MOCHAGUI* parent);
    ~ColdStakingWidget();
