...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, MOCHAGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, MOCHAGUI *gui, double posX = 3);
