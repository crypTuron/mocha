...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MOCHA:
        return QString("mocha");
    case mPIV:
        return QString("mmocha");
    case uPIV:
        return QString::fromUtf8("umocha");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit, bool isZpiv)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case MOCHA:
            return z + QString("MOCHA");
        case mPIV:
            return z + QString("mMOCHA");
        case uPIV:
            return z + QString::fromUtf8("μMOCHA");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MOCHA:
            return z + QString("tMOCHA");
        case mPIV:
            return z + QString("mtMOCHA");
        case uPIV:
            return z + QString::fromUtf8("μtMOCHA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MOCHA:
            return QString("MOCHA");
        case mPIV:
            return QString("Milli-MOCHA (1 / 1" THIN_SP_UTF8 "000)");
        case uPIV:
            return QString("Micro-MOCHA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
