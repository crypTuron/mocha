...
#include "qt/mocha/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR MOCHA</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                MOCHAGUI* window = static_cast<MOCHAGUI*>(parentWidget());
...
{
    MOCHAGUI* gui = static_cast<MOCHAGUI*>(parentWidget());
...
{
    hide();
    static_cast<MOCHAGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MOCHA will close now to finish the encryption process. "
