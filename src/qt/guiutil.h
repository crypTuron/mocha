...
/** Utility functions used by the MOCHA Qt UI.
 */
namespace GUIUtil
{
...
// Render MOCHA addresses in monospace font
...
// Parse "mocha:" URI into recipient object, return true on successful parsing
