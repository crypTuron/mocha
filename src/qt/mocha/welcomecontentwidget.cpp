...
#include "qt/mocha/forms/ui_welcomecontentwidget.h"
#include <QFile>
#include <QListView>
#include <QDir>
#include "guiutil.h"
    ...
    nextButton(new QPushButton())
{
    ...
    backButton->setStyleSheet("background: url(://ic-arrow-white-left); background-repeat:no-repeat;background-position:center;border:  0;background-color:#a53e32;color: #a53e32; border-radius:2px;");
    nextButton->move(nextX, nextY);
    nextButton->setStyleSheet("background: url(://ic-arrow-white-right);background-repeat:no-repeat;background-position:center;border:  0;background-color:#a53e32;color: #a53e32; border-radius:2px;");
