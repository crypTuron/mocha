...
#include "qt/mocha/coincontrolpivwidget.h"
#include "qt/mocha/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select MOCHA Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("MOCHA");
    ...
    ui->labelValueAfter->setText("0.00 MOCHA");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 MOCHA");
    ui->labelValueFee->setText("0.00 MOCHA");
