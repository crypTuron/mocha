...
#include "qt/mocha/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/mocha/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MOCHAGUI* _window, QWidget *parent) :
