...
#include "qt/mocha/settings/settingsnetworkwidget.h"
#include "qt/mocha/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/mocha/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MOCHAGUI* _window, QWidget *parent) :
