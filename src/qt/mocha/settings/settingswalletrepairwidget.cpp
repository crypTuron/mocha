...
#include "qt/mocha/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/mocha/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MOCHAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MOCHAGUI::handleRestart()
