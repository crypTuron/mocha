...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MOCHA features */
        {"mocha", "listmasternodes", &listmasternodes, true, true, false},
        {"mocha", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mocha", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mocha", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mocha", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mocha", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mocha", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mocha", "masternodedebug", &masternodedebug, true, true, false},
        {"mocha", "startmasternode", &startmasternode, true, true, false},
        {"mocha", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mocha", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mocha", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mocha", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mocha", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mocha", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mocha", "preparebudget", &preparebudget, true, true, false},
        {"mocha", "submitbudget", &submitbudget, true, true, false},
        {"mocha", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mocha", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mocha", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mocha", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mocha", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mocha", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mocha", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mocha", "checkbudgets", &checkbudgets, true, true, false},
        {"mocha", "mnsync", &mnsync, true, true, false},
        {"mocha", "spork", &spork, true, true, false},
        {"mocha", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getmbeansseed", &getmbeansseed, false, false, true},
        {"zerocoin", "setmbeansseed", &setmbeansseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdmbeans", &searchdmbeans, false, false, true},
        {"zerocoin", "dmbeansstate", &dmbeansstate, false, false, true},
...
{
    return "> mocha-cli " + methodname + " " + args + "\n";
}
