...
extern UniValue setmbeansseed(const UniValue& params, bool fHelp);
extern UniValue getmbeansseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdmbeans(const UniValue& params, bool fHelp);
extern UniValue dmbeansstate(const UniValue& params, bool fHelp);
