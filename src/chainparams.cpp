...
static Checkpoints::MapCheckpoints mapCheckpoints = 
    ...
    (0, uint256("000001de1a0fe3e52236ce2e60625db57e58c51a9a3cd58d92ef42fc5379dbf9"));
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet = 
    boost::assign::map_list_of
    (0, uint256("0000081c8097b3af7007a614b7984cbeb719c1d543b4073abb1681c30a9843c4"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest = 
    boost::assign::map_list_of(0, uint256("000001059617b816f52babccb98d6cee6783e4ba6ded517040a6ace1540176b6"));
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d");
        nDefaultPort = 21105;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // MOCHA starting difficulty is 1 / 2^12
        bnProofOfStakeLimit = ~uint256(0) >> 24;
        bnProofOfStakeLimit_V2 = ~uint256(0) >> 20; // 60/4 = 15 ==> use 2**4 higher limit
        nSubsidyHalvingInterval = 240000;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Decentralization tastes like coffee - 5/18/20";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1589914106;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1763694;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000001de1a0fe3e52236ce2e60625db57e58c51a9a3cd58d92ef42fc5379dbf9"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a mbeans to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 1000;
        nMochaBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nMochaBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        genesis.nNonce = 4027751;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000081c8097b3af7007a614b7984cbeb719c1d543b4073abb1681c30a9843c4"));
        ...
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 11);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // Testnet mocha BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet mocha BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet mocha BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1589840060;
        genesis.nNonce = 3292462;
        
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000001059617b816f52babccb98d6cee6783e4ba6ded517040a6ace1540176b6"));
