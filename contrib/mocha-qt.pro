...
RESOURCES += src/qt/mocha.qrc src/qt/mocha_locale.qrc

TRANSLATIONS += src/qt/locale/mocha_bg.ts \
                src/qt/locale/mocha_de.ts \
                src/qt/locale/mocha_en.ts \
                src/qt/locale/mocha_es.ts \
                src/qt/locale/mocha_fi.ts \
                src/qt/locale/mocha_fr.ts \
                src/qt/locale/mocha_it.ts \
                src/qt/locale/mocha_ja.ts \
                src/qt/locale/mocha_pl.ts \
                src/qt/locale/mocha_pt.ts \
                src/qt/locale/mocha_ru.ts \
                src/qt/locale/mocha_sk.ts \
                src/qt/locale/mocha_sv.ts \
                src/qt/locale/mocha_vi.ts \
                src/qt/locale/mocha_zh_CN.ts \
                src/qt/locale/mocha_zh_TW.ts
