...
The script [extract-osx-sdk.sh](https://github.com/mocha-project/mocha/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
mocha/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/mocha-project/mocha/blob/master/doc/README_osx.md) for troubleshooting tips.