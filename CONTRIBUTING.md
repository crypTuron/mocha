Contributing to MOCHA Core
============================

The MOCHA Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mocha-project/mocha/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MOCHA Core project, and is not to be
confused with overall MOCHA Network Protocol consensus changes.

Whether a pull request is merged into MOCHA Core rests with the project merge
...
Patches that change MOCHA consensus rules are considerably more involved than
...
Where a patchset proposes to change the MOCHA consensus, it must have been
...
The project leader is the release manager for each MOCHA Core release.
