...
from fake_stake.base_test import MOCHA_FakeStakeTest

class mBEANSwrappedSerialsTest(MOCHA_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom mBEANSs..." % DENOM_TO_USE)
